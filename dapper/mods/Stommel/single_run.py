...
tseq = modelling.Chronology(year*10, kko=np.array([],dtype=int), T=400*year, BurnIn=0)  # 1 observation/year
...
fig.savefig(os.path.join(fig_dir,'single_run.png'),format='png',dpi=500)
