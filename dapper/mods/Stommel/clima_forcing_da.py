...
def exp_clima_forcing_da(N=100, seed=1000):
    ...
    tseq = modelling.Chronology(
        year, kko=kko, T=200*year, BurnIn=0)  # 1 observation/year
    ...
    model.temp_air = [stommel.add_warming(f, sigs=[.5,0.]) for f in model.temp_air]
...
if __name__=='__main__':
    ...
    fig.savefig(os.path.join(fig_dir, 'clima_forcing_da.png'),format='png',dpi=500)
