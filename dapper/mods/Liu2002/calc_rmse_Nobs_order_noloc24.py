...
# Directory
fig_dir = os.path.join(exp.fig_dir,'rmse_Nobs_order_noloc24')
...
def exp_spectral_Nobs(T=50, Nens=24, sig_obs=1.0):
    ...
    for sig in np.array([1.]):
        Nobs_list = [int(o*exp.Ncells) for o in [.25,.5,1,2,4,8,16,32]]
    ...
    # Experiment
    tree.add_xp(E3DVar, Nens, loc_rad='X')
